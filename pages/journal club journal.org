...
*** DONE Krishnamurthy, S., & Smith, E. (2017). Solving Moment Hierarchies for Chemical Reaction Networks. https://arxiv.org/pdf/1702.01364.pdf  Reading the  first part helped clarify the notation for reaction networks.  At some later date, we might want to look at the examples more closely, build intuition for factorial moments, and study the moment hierarchies.
:PROPERTIES:
:done: 1613237438039
:END:
