...
- Contents
	...
	-
	  3. Results
		- 3.1. A single parameter in the large system limit
		- 3.2. Relative replication rates matter
		- 3.3. Mutation benefits the individual-advantageous type
		- 3.4. Population size matters
	-
	  4. Discussion and conclusion
	- Appendix A. Basic mathematical framework
		- A.1. Mathematical description
		- A.2. Stochastic implementation
		- A.3. Taking the limit $m \to \infty$
		- A.4. ODE approximation
		- A.5. Integro-partial differential equation approximation
		- A.6. Incorporating mutation
	- Appendix B. Public goods game framework
		- B.1. Mathematical description
		- B.2. Stochastic implementation
		- B.3. Taking $m \to \infty$
		- B.4. ODE approximation
		- B.5. Integro-partial differential equation approximation
		- B.6. Incorporating mutation
	-