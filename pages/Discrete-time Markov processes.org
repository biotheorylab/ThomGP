...
which is known as the _Chapman-Komolgorov Equation_.  Notationally, it is convenient to supress the summations by express this identity and the master equation in matrix form:
$$\begin{aligned} \mathbf{T}(t_3 ) \end{aligned}$$
* By iterating this identity, we may