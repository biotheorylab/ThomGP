* Here we systematically explain the theory of discrete-time Markov processes. For simplicity, we will restrict ourselves to finite state spaces and time finite so as to keep the exposition elementary.
...
* As a consequence of this definition, we derive three important formulae:
**