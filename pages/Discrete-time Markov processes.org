* Here we systematically derive some basic facts for discrete-time Markov processes. to keep the exposition elementary, we will restrict ourselves to finite state spaces and finite time so as
