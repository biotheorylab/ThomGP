...
* We now assume that the process is _one-step Markovian_, a.k.a. memoryless.  This means that future values only depend upon the present value and not on past values.  Specifically, given any times $0 < t_1 < t_2 < t_3 $ and any $q_1, q_2, q_3 \in S$, we have
$$ $$