...
$$\begin{aligned} &P (\{h \in H_{n} \mid h(t + 1) = q(t + 1)\} \mid \{h \in H_{n} \mid h(t) = q(t)\}) = \\ &P (\{h \in H_{n} \mid h(t + 1) = q(t + 1)\} \mid \{h \in H_{n} \mid h(t_2) = q_2 \land h(t_1) = q_1\}) \end{aligned}$$
