...
* We now assume that the process is _one-step Markovian_, a.k.a. memoryless.  This means that future values only depend upon the present value and not on past values.