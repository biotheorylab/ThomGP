* Here we systematically derive some basic facts for discrete-time Markov processes. For simplicity, we will restrict ourselves to finite state spaces and finite time so as
