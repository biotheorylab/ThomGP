...
A famaliar case is when \(f(x) = e^{x}\) is expanded in the Taylor series \(\sum_{k=0}^{\infty} x^n/n! \).  Because the factorial grows much faster than any exponential, this series converges
