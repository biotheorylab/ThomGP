...
** The two categories we introduced above are connected by a functor whose action on morphisms is give as
\[\begin{aligned} \mathcal{D} \colon \mathsf{PProb} &\to \mathsf{PStoch} \\ (D,f) &\mapsto \end{aligned}\]
