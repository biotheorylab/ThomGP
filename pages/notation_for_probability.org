...
** This construct combines several notions form probability theory.  To unpack it, we will make use of the factorization of the morphism \(m = (D,f)  \colon X \to Y \) as \( m = g \circ \)
