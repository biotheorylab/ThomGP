...
To reduce such an equation to a quasilinear equation, we introduce new variables \(p_{i}\) and equations \(p_{i} = \frac{\partial u}{\partial q_{i}}\).  Taking the derivative of the original equation and substituting, we obtain
\[ \]
