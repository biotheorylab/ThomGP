...
The equations we have just derived are quasi-linear.  Furthermore, we claim that, locally, solutions of this new system are equivalent to solutions of the original equation.  Suppose that \(p_{i}\)
