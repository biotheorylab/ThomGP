...
We begin with the linear differential equation of first order,
\[\sum_{i=1}^{n} a_{i} (q_{1}, \ldots q_{n}) \frac{\partial}{\partial q_{i}} \phi (q_{1}, \ldots q_{n}) + b(q_{1}, \ldots q_{n}) \phi (q_{1}, \ldots q_{n}) + c(q_{1}, \ldots q_{n}) = 0 .\]
