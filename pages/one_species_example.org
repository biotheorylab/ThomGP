...
** Next, we bring in the coherent states and obtain the equation of motion for the cumumlant generating function.  From the master equation and the definition of the generating 
\[e^{-\Gamma} \frac{\partial \Gamma}{\partial t} = -\langle 0 | e^{za} \mathcal{L} | \rho \rangle]
