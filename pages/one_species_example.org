...
** To illustrate techniques and concepts in "Intrinsic and Extrinsic Thermodynamics"  (which will hereafter be called "the paper"), we will write them out for the simple case of Schloegel's single species reaction system.  This is a standard exampe in the subject
:PROPERTIES:
:later: 1611887761901
:END:
\[\begin{aligned}
