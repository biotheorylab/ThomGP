...
\[ \frac{\partial^k}{\partial z^k} e^{-\Gamma} \approx e^{-\Gamma} \left( - \frac{\partial \Gamma}{\partial z} \right)^n\]
...
\[ \frac{\partial^n}{\partial z^n} e^{-\Gamma} \approx e^{-\Gamma} \left( \frac{n}{z} \right)
