...
$${\it ki}\,e^{2\,\vartheta-{\it kd}\,t}-{\it ki}\,e^{\vartheta+
 {\it kd}\,t}-{\it ki}\,e^{\vartheta-{\it kd}\,t}-{\it ki}\,e^{2\,
 \vartheta}-{\it kd}\,n\,e^{\vartheta}+2\,{\it ki}\,e^{\vartheta}-
 {\it kd}\,e^{\vartheta}-{\it kd}\,n\,e^{{\it kd}\,t}+{\it kd}\,n = 0$$
***
